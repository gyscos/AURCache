      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: buildActions(buildData)),
            const SizedBox(height: 15),
            const Divider(),
            const SizedBox(height: 5),
            const Text(
            ...
            const SizedBox(height: 20),
            SideCard(title: "Build Number", textRight: "#${buildData.id}"),
            SideCard(title: "Version", textRight: buildData.version),
            SideCard(
              title: "Finished",
        ...
        ElevatedButton(
          onPressed: () async {
            await showConfirmationDialog(
              context,
              "Cancel Build",
              "Are you sure to cancel this Build?",
              () {
        ...
        ElevatedButton(
          onPressed: () async {
            await showConfirmationDialog(
              context,
              "Delete Build",
              "Are you sure to delete this Build?",
              () async {
